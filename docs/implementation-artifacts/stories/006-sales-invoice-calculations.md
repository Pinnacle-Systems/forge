...
* `docs/prd.md`
* `docs/spec/modules/sales/sales-invoice.md`
* `docs/spec/platform/transaction-grid.md`
* `docs/spec/platform/lookup-autofill.md`
* `docs/implementation-artifacts/stories/002-sales-invoice-manifest-skeleton.md`
* `docs/implementation-artifacts/stories/003-transaction-grid-row-engine.md`
* `docs/implementation-artifacts/stories/004-lookup-runtime-foundation.md`
* `docs/implementation-artifacts/stories/005-sales-customer-and-product-lookup-providers.md`
...
* Story source list references `docs/implementation-artifacts/stories/005-sales-customer-and-product-lookup-providers.md`, but the actual completed story file is `docs/implementation-artifacts/stories/005-sales-customer-product-lookup-providers.md`.
...
* `docs/implementation-artifacts/stories/006-sales-invoice-calculations.md`
