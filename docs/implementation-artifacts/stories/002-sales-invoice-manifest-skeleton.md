...
- `docs/spec/platform/manifest-contract.md`
- `docs/spec/platform/instance-config-contract.md`
- `docs/spec/platform/merge-engine.md`
- `docs/spec/platform/lookup-autofill.md`
- `docs/implementation-artifacts/stories/001-runtime-transaction-definition-contract.md`
...
- Header, grid, and footer structure match `docs/spec/modules/sales/sales-invoice.md`.
